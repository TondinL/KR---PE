...
- c. We now want to find the posterior distribution of D, after observing the value x = 100 <br> p(D = d | X = 100). <br> Using bayes theorem, <br>  p(D = d | X = 100) =  p(X = 100 | D = d) * p(D = d) / p(X = 100) <br> The values at the numerator have been calculated at point a. and b.<br> p(X) is the normalization costant, that in this case we can ignore it. Multiplyng the two function at numerator we obtain <br> <br> <img src="https://raw.githubusercontent.com/TondinL/KR---PE/main/harry/images/es_1c1.png" width="270"/> <br> <br> Where C represents the constant values. 
